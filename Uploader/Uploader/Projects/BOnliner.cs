...
namespace Uploader
{
    class BOnliner : AbstractProject
    {
        ...
        public string getbuildcommabd(VSversion vs)
        {
            ...
            {
                return "\"C:/Program Files (x86)/Microsoft Visual Studio 14.0/Common7/IDE/devenv.exe\" /rebuild Debug C:/Users/Programmist/Desktop/BasketOnliner/BOnliner.sln";
            }

            if (vs == VSversion.VS2017)
            {
                return "\"C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/Common7/IDE/devenv.exe\" /rebuild Debug C:/Users/Programmist/Desktop/BasketOnliner/BOnliner.sln";
            }
            return "";
